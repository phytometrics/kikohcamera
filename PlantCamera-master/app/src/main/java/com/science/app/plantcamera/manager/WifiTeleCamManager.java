package com.science.app.plantcamera.manager;
...
import com.science.app.plantcamera.view.resolution.ResolutionDialog;
import com.science.app.plantcamera.view.resolution.ResolutionOption;
...
public class WifiTeleCamManager implements CamManager, MirrorFlipLayout.OnMirrorFlipListener,
    ...
    private WifiTeleConfigLayout configLayout;
    private TextView recordTimeText;
    private TextView fpsText;

    private WifiCameraController wifiCameraController;

    private WifiTeleCamManager(Builder builder) {
    ...
    public void takePhoto(String path) {
        wifiCameraController.takePhoto(path);
    }
    ...
    public static class Builder {
        ...
        public Builder bindConfigLayout(WifiTeleConfigLayout configLayout) {
