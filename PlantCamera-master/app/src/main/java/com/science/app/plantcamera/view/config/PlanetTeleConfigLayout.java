package com.science.app.plantcamera.view.config;
...
import com.science.app.plantcamera.view.config.component.ConfigComLayout;
import com.science.app.plantcamera.view.config.component.ConfigMixLayout;
import com.science.app.plantcamera.view.config.component.MirrorFlipLayout;
import com.science.app.plantcamera.view.config.component.PlanetControlLayout;
import com.science.app.plantcamera.view.config.component.TeleFocusLayout;
 ...
 */
public class PlanetTeleConfigLayout extends LinearLayout {
    @BindView(R.id.item_planet_control_layout_planet_config)
    PlanetControlLayout itemPlanetLayoutPlanetConfig;
    ...
    public PlanetTeleConfigLayout(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public PlanetTeleConfigLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initAttrs(attrs);
        init();
    ...
    public PlanetTeleConfigLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_planet_tele_config, this, true);
        ButterKnife.bind(this, view);
    }

    public void setOnPlanetControlListener(PlanetControlLayout.OnPlanetListener listener) {
        itemPlanetLayoutPlanetConfig.setOnPlanetListener(listener);
    }
